...
def parse_args():
    ...
    p.add_argument("--win-len", type=float, default=1.28, help="Window length in seconds.")
    p.add_argument("--win-stride", type=float, default=0.64, help="Window stride in seconds (overlap when < win-len).")
